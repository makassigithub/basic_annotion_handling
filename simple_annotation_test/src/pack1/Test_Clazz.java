...
public class Test_Clazz {
	...
	//get the attribute values from the interface and print
	  System.out.println("The Attr. value in the first method :" +itf.method_1()+ "\n" +
			 "The Attr. value in the first method :" + itf.method_2());
	...
	public static void this_meth2(String s, int i){
		...
		try{
			...
			// get the annotated Method object.Must explicitly provide the parameter list
			Method m = cl.getMethod("this_meth2", String.class, int.class);
			
			//get the annotation from the method. 
			// Interf.class is an  a Class object of the interface 
			Interf intf = m.getAnnotation(Interf.class);
			
			//get and print the annotations
			
			System.out.println("method_2 attr1 value: "+ intf.method_2());
